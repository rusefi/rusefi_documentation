...
* To be eligible for the prizes, all entries must be submitted via a permanent cloud storage link (Google Drive or Dropbox).
...
If music/effects/else is used, it must be royalty-free or licensed.
