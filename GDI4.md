...
GDI4 is an injector/HPFP driver, not a self-contained ECU. You would use it with either a rusEFI standalone or any other standalone with high pressure control functionality.
