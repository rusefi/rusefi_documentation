...
|---|---|---|---|
| Infiniti G35 sedan/coupe, Nissan Skyline V35 | 2003-2006 | VQ35DE | Same VQ35DE ECU generation as the 350Z. Community pinout at [allpinouts](https://allpinouts.org/pinouts/connectors/car/2003-2005-infiniti-g35-sedan-and-coupe-ecu/) lists 121 terminals; AT cars put ATF temperature sensors on pins 8 and 17. The 2003-2004 G35 sedan is reported to differ from the coupe and 350Z somewhere, so check it separately |
...
| Nissan Pathfinder (R51) | 2005-2012 | VQ40DE (and VK56DE 2008-2012) | Same drivetrain family as Xterra; 2011 Pathfinder ECU is MEC150; column in sheet is empty. [Issue 5](https://github.com/rusefi/hellen121nissan-issues/issues/5) asks about the V8 Pathfinder |
| Nissan Frontier (D40) | 2005-2019 | VQ40DE | Same family as Xterra for the early years. The [2017 Frontier diagram](OEM-Docs/Nissan/2017-frontier.pdf) in this repo should be checked before assuming late D40 trucks kept the 121 pin ECU |
...
* Fill the empty sheet columns: Pathfinder, Frontier (early and late D40), Quest, Rogue, Patrol, G35, FX35/FX45, Q45, QX56.
* Confirm whether the reported 2003-2004 G35 sedan difference is a pinout change or only a harness/immobilizer change.
* Confirm the crank/cam swap on pins 13/14 for the Altima I4 against the FSM, and whether the B15 Sentra is the same.
* Check whether late D40 Frontier (2013-2019) and R51 Pathfinder kept the 121 pin ECM; the repo has a [2017 Frontier diagram](OEM-Docs/Nissan/2017-frontier.pdf).
