...
There are several benefits to allowing the ECU to control the position of the throttle.
...
- A TPS - This is an angle sensor, commonly a potentiometer or Hall-effect sensor, which tells the ECU the actual position of the throttle. This is used as feedback to the ECU to accurately set and hold the throttle position.
