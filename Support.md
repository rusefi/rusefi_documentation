...
Technical support can be purchased on an hourly basis at [the rusEFI Store](https://www.shop.rusefi.com/shop/p/details-about-rusefi-ecu-technical-support). Supply limited.

## Community Support

Ask for help from someone in the community.

### Where to ask for help

In most cases, please start by posting your tune & log files on [rusEFI Online](Online) for easy access by those trying to help you. More information on how to do this can be found in the [rusEFI Online wiki page](Online).

The [rusEFI Forum](https://rusefi.com/forum/) is the primary free support channel.
