...
- Piggyback mode - something to help with integration of an MRE or similar in a piggyback config in situations where an OEM ECU must be retained either due to complexity or emissions testing.
