# Using TunerStudio as a Digital Dash

Click the image to watch a video of a Raspberry Pi rusEFI connected display. This is an early "proof of concept".
...
2. Extract it to your home directory.
    ...
    1. The default home directory is "pi". Open a terminal and type: `ls /home/pi/TunerStudioMS` (if your home directory isnt "pi" change it to match your home directory)

    2. Ensure that "TunerStudio.sh" shows up in the results. If it does not, re-install.

        Note: you MAY need to install JAVA... if so, type

        `sudo apt-get install openjdk-8-jre`

        To set the default Java runtime

        `sudo update-alternatives --config java`

3. Create a link to start TunerStudio:

    Open terminal and type: `ln -s /home/pi/TunerStudioMS/TunerStudio.sh /usr/local/bin`

4. Once complete in terminal type: type: "bash /usr/local/bin/TunerStudio.sh"

5. TunerStudio will open. Enter your registration information now.

6. Load your tune and dash.

7. Go to options - preferences - select "load last project on startup" *paid TunerStudio function*

8. Go to options - preferences - select "make dashboard fullscreen" *paid TunerStudio function*

9. Save the tune. Close TunerStudio.

Here is a [site](https://tunerstudiodashboards.com) with free dashboards to spice up your look.

Here is a [site](https://tunerstudio.com/index.php/support/manuals/53-using-tunerstudio-dashboard-designer) on how to make your own custom dashboards.
